...
public class TimeTable {
	...
	public TimeTable(String cfName, String saName, int roomsPerSession, int sessionsPerDay) throws Throwable {
		numRooms = roomsPerSession;
		numSessions = sessionsPerDay;
